                        ...
                        children: <Widget>[
                          ...
                          Container(
                            ...
                            child: Row(
                              children: [
                                GestureDetector(
                                    child: IconButton(icon: new Icon(Icons.add),onPressed: ()=>setState(()=>_itemCount++))),
                                Text(_itemCount.toString(),style: TextStyle(color: Colors.black),),
                                GestureDetector(
                                    child: IconButton(icon: new Icon(Icons.remove),onPressed: ()=>setState(()=>_itemCount--),)),
                              ],
                            ),
                          )
                          // ]
